...
public class SqlHelper extends SQLiteOpenHelper {
    ...
    List<Register> getRegisterBy(String type) {
        ...
        try {
            ...
            Log.e("ERRO DE LEITURA", e.getMessage(), e);
        } finally {
    ...
    long addItem(String type, double response) {
        ...
        try {
            ...
            SimpleDateFormat format = new SimpleDateFormat("YYYY_MM_dd HH:mm:ss", new Locale("pt", "BR"));
            ...
            Log.e("ERRO DE ESCRITA", e.getMessage(), e);
        }finally {
            db.endTransaction();
        }
        return calcId;
